package com.yj.jenkinsdemo.base;
...
public abstract class BaseServiceImpl<Repository extends JpaRepository,Mapper, Record, Example,ID> implements BaseService<Record, Example,ID>{
    ...
    @Override
    public Record findById(ID id){
        return (Record) repository.findById(id).get();
    }
    @Override
